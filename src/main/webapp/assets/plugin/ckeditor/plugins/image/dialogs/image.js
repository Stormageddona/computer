                    ...
                    },
                    {
                        ...
                        children: [{
                            ...
                            children: [{
                                ...
                                children: [{
                                    ...
                                    html: '<div><a href="javascript:void(0)" tabindex="-1" title="' +
                                        d.lang.image.lockRatio + '" class="cke_btn_locked" id="' + r + '" role="checkbox"><span class="cke_icon"></span><span class="cke_label">' + d.lang.image.lockRatio + '</span></a><a href="javascript:void(0)" tabindex="-1" title="' + d.lang.image.resetSize + '" class="cke_btn_reset" id="' + x + '" role="button"><span class="cke_label">' + d.lang.image.resetSize + "</span></a></div>"
                                }]
                            }, {
                                type: "vbox",
                                padding: 1,
                            ...
                            children: [{
                                ...
                                id: "htmlPreview",
                                style: "width:95%;",
                                html: "<div>" + CKEDITOR.tools.htmlEncode(d.lang.common.preview) + '<br><div id="' +
                                    n + '" class="ImagePreviewLoader" style="display:none"><div class="loading">\x26nbsp;</div></div><div class="ImagePreviewBox"><table><tr><td><a href="javascript:void(0)" target="_blank" onclick="return false;" id="' + D + '"><img id="' + C + '" alt="" /></a>' + (d.config.image_previewText) +
                                    "</td></tr></table></div></div>"
                            }]
                        }]
                    }
